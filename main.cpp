...
int senoide[] = {
    ...
    0x76, 0x79, 0x7c, 0x80}; // Look Up table para gerar um sinal senoidal
...
int main() {
  ...
  troca_onda.fall(&rotina_troca_onda); // Define quando o botão vai ser
                                       // detectado
  clk_func.attach(&clock_func, 2.6042e-4);
  ...
  while (1) {
    ...
    rotina_frequencia(encoder.getPulses());
